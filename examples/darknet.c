...
extern void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *ip, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen);
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        test_detector("cfg/coco.data", argv[2], argv[3], argv[4], filename, thresh, .5, outfile, fullscreen);
